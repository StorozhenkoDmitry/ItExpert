...
namespace mTouchPDFReader.Library.Views.Core
{
	public class PageView : UIScrollView
	{
		...
		public override void TouchesBegan(NSSet touches, UIEvent evt)
		{
			...
			if (Options.Instance.AllowZoomByDoubleTouch) {
		...
		private void _UpdateMinimumMaximumZoom()
		{
			...
			MaximumZoomScale = zoomScale * Options.Instance.ZoomScaleLevels; 
			_ZoomScaleStep = (MaximumZoomScale - MinimumZoomScale) / Options.Instance.ZoomScaleLevels;
		}
